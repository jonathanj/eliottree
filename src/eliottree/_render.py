    ...
    if human_readable:
        fields = {
            eliot_ns(u'timestamp'): format.timestamp(
                include_microsecond=include_microseconds,
...
def render_tasks(write, tasks, field_limit=0, ignored_fields=None,
                 ...
                 utc_timestamps=True, include_microseconds=False,
    ...
    :param bool include_microseconds: Include microsecond in formatted timestamps?
